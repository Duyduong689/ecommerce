    ...
    return (
        <div className=" rounded-xl w-72 mb-10 mx-auto md:mx-0 overflow-hidden text-black">
            ...
            <div className="p-4 bg-white">
                <div className=" flex justify-between text-xl font-semibold overflow-hidden">
                    <p className=" overflow-ellipsis text-nowrap overflow-hidden w-fit">{name}</p>
                    <p className=" min-w-[63px]">$ {price}</p>
                </div>
                <p className=" pt-2 text-xs">{type} Room</p>
                <p className=" pt-3 pb-6 text-xs">{description.slice(1, 100)}...</p>
